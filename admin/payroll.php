                                    ...
                                    <form method="POST" class="form-inline" id="payForm">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pull-right col-sm-8" id="reservation"
                                                name="date_range" value="<?php echo isset(
                                                    $_GET['range']
                                                )
                                                    ? $_GET['range']
                                                    : $range_from .
                                        ...
                                        <button type="button" class="btn btn-success btn-sm btn-flat" id="payroll"><span
                                                class="glyphicon glyphicon-print"></span> Payroll</button>
                                        <button type="button" class="btn btn-primary btn-sm btn-flat" id="payslip"><span
                                                class="glyphicon glyphicon-print"></span> Payslip</button>
                                    </form>
                                </div>
                            </div>
                            <div class="box-body">
                                <table id="example1" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM attendance  WHERE date BETWEEN '$from' AND '$to'";
                                        $query = $conn->query($sql);
                                        $total = 0;
                                        while ($row = $query->fetch_assoc()) {
                                            $empid = $row['empid'];
                                            $casql = "SELECT * FROM cashadvance WHERE employee_id='$empid' AND date_advance BETWEEN '$from' AND '$to'";
